 ...
 * LiveVideoPlayer: Backward-compatible wrapper delegating to the unified
 * WebRTC/WHEP + HLS fallback CameraPlayer component.
...
function LiveVideoPlayer({
  ...
  const camObj = camera || { camera_code: cameraCode, id: cameraCode };
  return (
    <div
      ref={containerRef}
      style={{
